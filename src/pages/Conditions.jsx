          ...
          return (
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuItem onClick={() => handleEdit(cond)}>
                  Edit condition
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem
        ...
        <div className="">
          ...
          >
            ...
            <DrawerContent className="ml-auto h-full max-w-3xl">
              <DrawerHeader>
                <DrawerTitle>{editingId ? "Edit Condition" : "Add New Condition"}</DrawerTitle>
                <DrawerDescription>
                  {editingId ? "Update the condition details." : "Fill in the details below to add a new condition."}
                </DrawerDescription>
              </DrawerHeader>
              <div className="no-scrollbar overflow-y-auto px-6 pb-8">
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <Field>
                    ...
                    <Input id="condition-name" type="text" placeholder="Condition Name" ref={nameInputRef} value={name} onChange={(e) => setName(e.target.value)} className="mt-1" required />
                  </Field>
                  <Field>
        ...
        <div className="">
          <div className="flex justify-between items-center mb-4 gap-4">
            <div className="w-full flex flex-col md:flex-row gap-4 items-center">
              <div className="flex-3 w-full">
                <Input type="text" placeholder="Search conditions..." value={search} onChange={(e) => setSearch(e.target.value)} className="w-full" />
              </div>
          ...
          {conditionsLoading ? (
            ...
            <div className="overflow-x-auto">
              <DataTable columns={conditionColumns} data={filteredConditions} pageSize={itemsPerPage} />
            </div>
          )}
        </div>
      </div>
