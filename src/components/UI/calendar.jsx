  ...
  return (
    <div className="relative w-fit">
      <DayPicker
        ...
        className={cn(
          "bg-background group/calendar p-3 pb-8 [--cell-size:2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      {hasSelection && (
        <button
          type="button"
          onClick={handleClear}
          className="absolute bottom-2 right-3 text-sm underline text-muted-foreground hover:text-foreground transition-colors"
        >
          Clear
        </button>
      )}
